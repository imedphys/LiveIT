...
(function () {
    ...
    function initChartJS() {
        ...
        var doughnutData = {
            ...
            datasets: [{
                data: [300, 50, 100],
                backgroundColor: ['#7266ba', '#fad732', '##1d8cc1'],
                hoverBackgroundColor: ['#7266ba', '#fad732', '##1d8cc1']
            }]
        };
        var doughnutOptions = {
            legend: {
